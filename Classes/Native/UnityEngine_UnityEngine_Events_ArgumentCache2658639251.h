...
public:
	inline static int32_t get_offset_of_m_ObjectArgumentAssemblyTypeName_0() { return static_cast<int32_t>(offsetof(ArgumentCache_t2658639251, ___m_ObjectArgumentAssemblyTypeName_0)); }
