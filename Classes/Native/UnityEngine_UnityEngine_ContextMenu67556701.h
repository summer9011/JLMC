...
struct  ContextMenu_t67556701  : public Attribute_t1145342165
{
public:
...
public:
	inline static int32_t get_offset_of_m_ItemName_0() { return static_cast<int32_t>(offsetof(ContextMenu_t67556701, ___m_ItemName_0)); }
