...
struct  Gyroscope_t1746339172  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_m_GyroIndex_0() { return static_cast<int32_t>(offsetof(Gyroscope_t1746339172, ___m_GyroIndex_0)); }
