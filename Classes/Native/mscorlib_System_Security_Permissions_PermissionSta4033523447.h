...
struct  PermissionState_t4033523447 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PermissionState_t4033523447, ___value___1)); }
