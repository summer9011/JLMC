...
struct  EnvironmentPermissionAccess_t1495257167 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(EnvironmentPermissionAccess_t1495257167, ___value___1)); }
