...
struct  RemoteNotification_t3995298175  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_notificationWrapper_0() { return static_cast<int32_t>(offsetof(RemoteNotification_t3995298175, ___notificationWrapper_0)); }
