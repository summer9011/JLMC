...
struct  ControlScheme_t3085753218 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ControlScheme_t3085753218, ___value___1)); }
